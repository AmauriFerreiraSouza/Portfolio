    ...
    >
      <div class="flex flex-col md:flex-row items-center h-full pt-8">
            ...
            <div class="flex items-center mb-6">
              <a
                class="
                  ...
                  sm:mr-4
                "
                href="https://www.facebook.com/profile.php?id=100087576730828" target="_blank"
              >
                <svg
                  width="8"
                  height="16"
              ...
              <a
                class="
                  ...
                  sm:mr-4
                "
                href="https://www.youtube.com/channel/UCFSqeOg82VO7QswM54afGIQ" target="_blank"
              >
                <svg
                  width="16"
                  height="12"
              ...
              <a
                class="
                  ...
                  sm:mr-4
                "
                href="https://www.linkedin.com/in/amauri-souza-a51aa4128/" target="_blank"
              >
                <svg
                  width="14"
                  height="14"
        ...
        <div class="flex flex-1 justify-end items-center h-full mt-8 md:mt-0">
          <img
            class="rounded-lg"
            src="http://127.0.0.1:8000/img/me.jpg"
            alt="Hero"
          />
        </div>
      </div>
